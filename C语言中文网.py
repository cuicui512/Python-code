#爬取C语言中文网的教程为PDF和HTML
#原贴地址：https://www.52pojie.cn/thread-990598-1-2.html
...
def getdata(url,pdf):
    ...
    if mkdir(savepath+folder):
        ...
        if pdf:
            print('开始生成pdf,请稍候...')
            path_wk = r'D:\Softwares\wkhtmltopdf\bin\wkhtmltopdf.exe'  # wkhtmltopdf安装位置
...
if __name__ == '__main__':
    url = 'http://c.biancheng.net/android/' #获取教程url地址
    savepath='C:\\Users\lx223\Desktop\C语言中文网'   #保存位置
